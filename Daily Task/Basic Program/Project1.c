/*Problem: This is going to be fun!!  We will write a program that generates a random number and 
...
int main()
{
    ...
    do{
        ...
        scanf("%d", &guess);
        if(guess>number){
            printf("Lower number type please!\n");
        }
        else if(guess<number){
            printf("Higher number type please!\n");
        }
        else{
